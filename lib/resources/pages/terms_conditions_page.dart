...
class TermsConditionsPage extends NyStatefulWidget {
  ...
  TermsConditionsPage({super.key})
      : super(child: () => _TermsConditionsPageState());
}

class _TermsConditionsPageState extends NyPage<TermsConditionsPage> {
  late WebViewController _webViewController;
  bool _isLoading = true;
  final String _termsConditionsUrl =
      'https://bybhavani.com/terms_conditions.php';
  ...
  void _initializeWebView() {
    _webViewController = WebViewController()
      ...
      ..loadRequest(Uri.parse(_termsConditionsUrl));
  }
